...
const BASE_API_URL = `https://graphql-gateway.axieinfinity.com/graphql`;

const OPERATION_NAMES = {
  GetAxieBriefList: 'GetAxieBriefList'
};
...
const BINARY_TRAITS = {
  'beast': {
    ...
    'ears': {
      ...
      '001000': { 'global': 'Zen' }, '001100': { 'global': 'Belieber' }
    },
    'back': {
  ...
  'bug': {
    'mouth': {
      ...
      '000100': { 'global': 'Pincer' }, '001010': { 'global': 'Square Teeth' }
    },
    'horn': {
  ...
  'reptile': {
    ...
    'tail': {
      '000100': { 'global': 'Iguana' }, '000010': { 'global': 'Wall Gecko', 'mystic': 'Escaped Gecko' }, '000110': { 'global': 'Tiny Dino' }, '001000': { 'global': 'Snake Jar', 'xmas': 'December Surprise' }, '001010': { 'global': 'Gila' },
      '001100': { 'global': 'Grass Snake' }
    },
    'horn': {
      '000010': { 'global': 'Unko', 'mystic': 'Pinku Unko' }, '000110': { 'global': 'Cerastes' }, '000100': { 'global': 'Scaly Spear' }, '001010': { 'global': 'Incisor' }, '001000': { 'global': 'Scaly Spoon' },
      '001100': { 'global': 'Bumpy' }
    }
  },
  'plant': {
    'tail': {
      '001000': { 'global': 'Yam' }, '000010': { 'global': 'Carrot', 'mystic': 'Namek Carrot' }, '000100': { 'global': 'Cattail' }, '000110': { 'global': 'Hatsune' }, '001010': { 'global': 'Potato Leaf' },
      '001100': { 'global': 'Hot Butt' }
    },
    'mouth': {
      '000100': { 'global': 'Zigzag', 'xmas': 'Rudolph' }, '000010': { 'global': 'Serious', 'mystic': 'Humorless' }, '001000': { 'global': 'Herbivore' },
      '001010': { 'global': 'Silence Whisper' }
    },
    'eyes': {
      '000010': { 'global': 'Papi', 'mystic': 'Dreamy Papi' }, '000100': { 'global': 'Confused' }, '001010': { 'global': 'Blossom' },
      '001000': { 'global': 'Cucumber Slice' }
    },
    'ears': {
      '000010': { 'global': 'Leafy', 'mystic': 'The Last Leaf' }, '000110': { 'global': 'Rosa' }, '000100': { 'global': 'Clover' }, '001000': { 'global': 'Sakura', 'japan': 'Maiko' }, '001010': { 'global': 'Hollow' },
      '001100': { 'global': 'Lotus' }
    },
    'back': {
      '000110': { 'global': 'Bidens' }, '000100': { 'global': 'Shiitake', 'japan': 'Yakitori' }, '000010': { 'global': 'Turnip', 'mystic': 'Pink Turnip' }, '001010': { 'global': 'Mint' }, '001000': { 'global': 'Watering Can' },
      '001100': { 'global': 'Pumpkin' }
    },
    'horn': {
      '000100': { 'global': 'Beech', 'japan': 'Yorishiro' }, '000110': { 'global': 'Rose Bud' }, '000010': { 'global': 'Bamboo Shoot', 'mystic': 'Golden Bamboo Shoot' }, '001010': { 'global': 'Cactus' }, '001000': { 'global': 'Strawberry Shortcake' },
      '001100': { 'global': 'Watermelon' }
    }
  }
};

const bodyPartsJsonFileName = `///Users/diego.ramirez/workspace/axie/axie/lib/data/body-parts.json`;

const getBodyPartsMap = () => {
  const parts = JSON.parse(fs.readFileSync(bodyPartsJsonFileName, 'utf8'));
  const bodyPartsMap = {};
